...
=head1 SYNOPSIS
 ...
 if ($response->is_success){ 
     ...
     print STDERR "An error occurred with code "
         . $response->error_code
         . ":" 
         . $response->error,"\n";
 }
...
A response object is returned from various calls in the 3Scale API, the 
following fields are of relevance:
...
Indicates if the operation which generated the response was successfull. 
Successful responses will have an associated transaction within the response. 
...
Returns the error code  (as a string) which was genrerated by this response, 
these correspond to constants exported by the Net::ThreeScale::Client module. 
See Net::ThreeScale::Client for a list of available response codes. 
